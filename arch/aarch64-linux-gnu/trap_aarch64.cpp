...
extern "C" void aarch64_handle_sync_exception(HAL::CpuContext* ctx, uint64_t esr, uint64_t far) {
    uint32_t eclass = (esr >> 26) & 0x3F; // Extract Exception Class (EC)
